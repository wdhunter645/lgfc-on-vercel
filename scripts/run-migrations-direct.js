 ...
 * Runs SQL migrations directly using PostgreSQL connection
 * This is an alternative when service role key is not available
 */
...
async function runMigrations() {
  console.log('\n🚀 Running Database Migrations (Direct Connection)...\n');
  ...
  if (!supabaseUrl || !projectId || !dbPassword) {
  ...
  try {
    ...
    log.info('This might be due to network restrictions.');
    log.info('Alternative: Run migrations manually in Supabase SQL Editor');
    process.exit(1);
  }
